export const WEBSOCKET_PUBLIC_URL = process.env.RENDER_EXTERNAL_URL 
  ? `${process.env.RENDER_EXTERNAL_URL}/api/socket`
  : (process.env.WEBSOCKET_PUBLIC_URL || "http://localhost:5505/")
