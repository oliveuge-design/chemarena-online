...
export default function SmartGameLauncher() {
  ...
  const smartLaunch = useCallback(async () => {
    ...
    try {
      ...
      toast.loading('4/4 - Avvio gioco...', { id: 'launch' })
  ...
  return (
    <div className="space-y-6">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {quizzes.map((quiz) => (
                  <tr
                    key={quiz.id}
                    className={selectedQuiz?.id === quiz.id ? 'bg-blue-50' : 'hover:bg-gray-50'}
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        {selectedQuiz?.id === quiz.id ? 'Selezionato' : 'Seleziona'}
                      </button>
                    </td>
                  </tr>
                ))}
      ...
      <div className={selectedQuiz ? 'bg-white rounded-lg shadow-md p-6 opacity-100 transition-opacity duration-300' : 'bg-white rounded-lg shadow-md p-6 opacity-0 pointer-events-none transition-opacity duration-300'}>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">
          2. Lancio Automatico
        </h3>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mb-2">
              Quiz Selezionato: {selectedQuiz?.title || 'Nessun quiz selezionato'}
            </h4>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium">{selectedQuiz?.questions?.length || 0}</div>
                </div>
                <div>
                  <span className="text-blue-600">Difficoltà:</span>
                  <div className="font-medium">{selectedQuiz ? getDifficulty(selectedQuiz) : '-'}</div>
                </div>
              </div>
            </div>
